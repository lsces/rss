		...
		<table class="table data">
			...
			<tr class="{cycle values='odd,even'}">
				...
				<td>
				   ...
				   <a href="{$smarty.const.RSS_PKG_URL}admin/admin_rssmodules.php?offset={$offset}&amp;sort_mode={$sort_mode}&amp;remove={$channels[user].rss_id}">{biticon ipackage="icons" iname="edit-delete" ipackage="icons" iexplain=remove}</a>
				</td>
			</tr>
			{sectionelse}
